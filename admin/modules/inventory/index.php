...
<body class="pc-shell">
    ...
    <div class="pc-container">
        <div class="pc-page-header pc-animate">
            <div class="pc-breadcrumb">Home <i class="fas fa-chevron-right"></i> Inventory</div>
            <div class="flex justify-between items-center gap-4">
            <div>
                <h1 class="pc-page-title">Inventory Management</h1>
                <p class="pc-page-subtitle">Modern stock control, expiry visibility, and medicine actions</p>
            </div>
            <a href="add_medicine.php" class="pc-btn pc-btn-primary">
        ...
        <div class="pc-toolbar mb-6 pc-animate">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="category" class="pc-select">
                ...
                <div class="flex items-end">
                    <button type="submit" class="w-full pc-btn pc-btn-secondary">
        ...
        <div class="pc-table-wrap pc-animate">
            <div class="overflow-x-auto">
                <table class="pc-table min-w-full divide-y divide-gray-200">
