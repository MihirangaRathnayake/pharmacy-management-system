...
<body class="pc-shell transition-colors duration-300">
    <?php include '../../includes/navbar.php'; ?>
    
    <div class="pc-container">
        <div class="pc-page-header">
            <div class="pc-breadcrumb">Home <i class="fas fa-chevron-right"></i> Settings</div>
            <h1 class="pc-page-title">Settings</h1>
            <p class="pc-page-subtitle">Manage account profile, preferences, and security</p>
        </div>
