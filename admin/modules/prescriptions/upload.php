...
<body class="pc-shell">
    ...
    <div class="pc-container">
        <div class="pc-page-header pc-animate">
            <div class="pc-breadcrumb">Home <i class="fas fa-chevron-right"></i> Prescription Upload</div>
            <div class="flex justify-between items-center gap-4">
            <div>
                <h1 class="pc-page-title">Prescription Upload</h1>
                <p class="pc-page-subtitle">Drag and drop prescription files with clear processing flow</p>
            </div>
            ...
            <div class="pc-card p-8">
                <form method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="pc-upload-zone rounded-lg p-8 text-center" id="dropZone">
