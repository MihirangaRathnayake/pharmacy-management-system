...
<head>
    ...
    <?php require_once '../../includes/action_buttons.php'; echo renderActionButtonsCSS(); ?>
</head>
<body class="pc-shell">
    ...
    <div class="pc-container">
        <div class="pc-page-header pc-animate">
            <div class="pc-breadcrumb">Home <i class="fas fa-chevron-right"></i> Customers</div>
            <div class="flex justify-between items-center gap-4">
            <div>
                <h1 class="pc-page-title">Customer Management</h1>
                <p class="pc-page-subtitle">Customer profiles, spend analysis, and relationship history</p>
            </div>
            <a href="add_customer.php" class="pc-btn pc-btn-primary">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php foreach ($customers as $customer): ?>
                <div class="pc-card p-6 customer-card">
