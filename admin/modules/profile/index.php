...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="profile-card mb-8">
            <div class="profile-header px-8 py-10">
                <div class="flex items-center space-x-8">
                    <!-- Professional Profile Image -->
                    <div class="profile-image-container">
                        <img id="profileImage" 
                             src="<?php echo $user['profile_image'] ? '../../uploads/profiles/' . $user['profile_image'] : '../../assets/images/default-avatar.svg'; ?>" 
                             alt="<?php echo htmlspecialchars($user['name']); ?>" 
                             class="rounded-full object-cover"
                             onerror="this.src='../../assets/images/default-avatar.svg'"
                             style="transition: all 0.3s ease;">
                        
                        <div class="profile-image-overlay" onclick="document.getElementById('imageUpload').click()">
                            <i class="fas fa-camera" style="font-family: 'Font Awesome 6 Free' !important; font-weight: 900 !important;"></i>
                            <div style="margin-top: 8px; font-size: 12px; font-weight: 600;">Change Photo</div>
                        </div>
                        
                        <button class="profile-upload-btn" onclick="document.getElementById('imageUpload').click()" 
                                data-tooltip="Upload New Profile Picture" type="button">
                            <i class="fas fa-camera" style="font-family: 'Font Awesome 6 Free' !important; font-weight: 900 !important;"></i>
                        </button>
                    ...
                    <div class="text-white flex-grow">
                        ...
                        <div class="flex items-center gap-4 mb-3">
                            <span class="profile-status-badge profile-status-<?php echo $user['status']; ?>">
                                <i class="fas fa-circle"></i>
                                <?php echo ucfirst($user['status']); ?>
                            </span>
                            <span class="text-lg capitalize bg-white bg-opacity-20 px-3 py-1 rounded-full">
                                <i class="fas fa-user-shield mr-2"></i>
                                <?php echo htmlspecialchars($user['role']); ?>
                            </span>
                        </div>
                        <p class="text-white text-opacity-90 text-lg mb-2">
