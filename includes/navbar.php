            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border z-50">
                        <a href="/modules/profile/index.php" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 transition duration-200">
                        ...
                        <hr class="my-1">
                        <a href="/auth/logout.php" class="block px-4 py-2 text-red-600 hover:bg-red-50 transition duration-200">
